...
namespace Essentials.Pointers
{
    public class TouchWatcher : MonoBehaviour
    {
        ...
        public static Vector2 DeltaDrag(int touches)
        {
            ...
            Vector2 delta = VectorEssentials.LerpMulti(_instance.CurrentTouchesDeltaPositions);
            delta.y = -delta.y;
        ...
        public static float DeltaZoom(int touches)
        {
            ...
            {
                Vector2 center = VectorEssentials.LerpMulti(inspectedTouches);
        ...
        public static float DeltaTwist(int touches)
        {
            ...
            Vector2 touchesCenter = VectorEssentials.LerpMulti(_instance.PreviousTouchesPositions);
            ...
            float DeltaAngleForTouch(Vector2 center, Touch inspectedTouch)
            {
                ...
                float previousAngle = VectorEssentials.ToDegrees(inspectedTouch.position - inspectedTouch.deltaPosition - center);
                float currentAngle = VectorEssentials.ToDegrees(inspectedTouch.position - center);
        ...
        public class SwipeContext
        {
            ...
            public SwipeContext(Vector2 originPosition, Vector2 releasePosition, float time)
            {
                ...
                _angle = VectorEssentials.ToDegrees(DeltaPosition);
            }
