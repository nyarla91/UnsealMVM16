...
{
    public static class CollectionEssentials
    {
        public static List<T> PickRandomElements<T>(this List<T> collection, int ammount)
        {
        ...
        public static T PickRandomElement<T>(this List<T> collection)
        {
            if (collection.Count <= 0)
